export const domContent = [
  {
    ...
    details: [
      ...
      "1.  We design posters, templates, create posts and stories in GFX.",
      "2.  Make reels and short videos for VFX.",
  ...
  },
  {
    title: "technical",
    details: [
      "Be it a classy App with it's amazing UI or a website with it's superb backend-technical domain is here to help you solve every bug you'll ever have!",
      "We have 3 subdomains, which are as follows-",
      "1.  AI/ML- Making the use of Artificial Intelligence and Machine Learning resourceful by landing in some amazing projects.",
